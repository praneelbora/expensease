...
export default function BottomSheetLayout({
  ...
  return (
    <MainBottomSheet innerRef={innerRef} onDismiss={onClose} addView={addView}>
      ...
      {/* Footer wrap */}
      <View style={[styles.footerWrap, { height: footerTotalHeight, paddingBottom: footerPaddingBottom, borderTopColor: colors.border || "#333", backgroundColor: colors.card || "#1f1f1f" }]}>
        {footerContent}
      </View>
    </MainBottomSheet>
  );
