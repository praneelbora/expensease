                    ...
                    {simplifiedTransactions.map((t, i) => {
                        ...
                        return (
                            <Text key={i} style={{ color: youPay || youReceive ? "#EBF1D5" : "#81827C" }}>
                                {t.from === userId ? "You" : t.fromName} {youPay ? "owe" : "owes"} {t.to === userId ? "You" : t.toName} <Text style={{ color: youPay ? "#EA4335" : youReceive ? "#60DFC9" : "#EBF1D5" }}>{amtTxt}</Text>
                            </Text>
                        );
                    })}
                </View>
        ...
        <SafeAreaView style={styles.safe} edges={["top"]}>
            ...
            <View style={{ flex: 1, paddingHorizontal: 16, paddingTop: 8, gap: 8 }}>
                ...
                <BottomSheetSettle
                    ...
                    onSubmit={recordSettlement}   // handles custom or single settlement
